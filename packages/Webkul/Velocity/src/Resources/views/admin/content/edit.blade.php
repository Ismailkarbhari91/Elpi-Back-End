                ...
                <accordian :title="'{{ __('velocity::app.admin.contents.tab.page') }}'" :active="true">
                    <div slot="body">
                        ...
                        <div class="control-group">
                                ...
                                <select class="control" id="visible_in_footer" name="visible_in_footer">
                                    <option value="1" {{ $content->visible_in_footer ? '' : 'selected' }}>
                                        {{ 'Yes' }}</option>
                                    <option value="0" {{ $content->visible_in_footer ? '' : 'selected' }} >
                                        {{ 'No' }}</option>
                                </select>
                        </div>
                        <!--  -->
                         ...
                         <div class="control-group">
                                ...
                                <select class="control" id="type" name="type">
                                        <option value="text" {{ $content->type ? '' : 'selected' }}>
                                        {{ 'Text' }}</option>
                                        <option value="icon" {{ $content->type ? '' : 'selected' }} >
                                        {{ 'Icon' }}</option>
                                </select>
                        </div>
                        <!--  -->
