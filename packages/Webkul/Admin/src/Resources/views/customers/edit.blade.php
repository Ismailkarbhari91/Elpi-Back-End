    ...
    <div class="content">
        ...
        <tabs>
            {!! view_render_event('bagisto.admin.customer.edit.before', ['customer' => $customer]) !!}
                ...
                <!--  -->
                <tab name="{{ __('Billing Address') }}" :selected="false">                
                    <div class="page-content">
                        <div class="page-content-button">
                            <a href="{{ route('admin.customer.billing', $customer->id) }}" class="btn btn-lg btn-primary">
                                {{ __('Show Billing Address') }}
                            </a>
                        </div>
                ...
                <!-- shipping -->
                <tab name="{{ __('Shipping Address') }}" :selected="false">                
                    <div class="page-content">
                        <div class="page-content-button">
                            <a href="{{ route('admin.customer.shipping', $customer->id) }}" class="btn btn-lg btn-primary">
                                {{ __('Show Shipping Address') }}
                            </a>
                        </div>
