                        ...
                        <div slot="body">
                            ...
                            <div class="control-group">
                             ...
                             <div class="control-group">
                                ...
                                <select class="control" id="product_collection" name="product_collection">
                                    <option value="1" {{ $attribute->product_collection ? '' : 'selected' }}>
                                        {{ 'Yes' }}</option>
                                    <option value="0" {{ $attribute->product_collection ? '' : 'selected' }} >
                                        {{ 'No' }}</option>
                                </select>
                            </div>
                            <!--  -->
