...
class ShippingsController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $user = Shipping::where('customer_id', $customerId)->first();
    ...
    public function store(Request $request, $id)
    {
        ...
        DB::table('shipping')
            ...
            ->update(['first_name' =>$fname,'last_name'=>$lname,'company_name'=>$company_name,'country'=>$country,'address1'=>$address1,'address2'=>$address2,'city'=>$city,'state'=>$state,'zipcode'=>$zipcode,'customer_id'=>$customer_id]);
