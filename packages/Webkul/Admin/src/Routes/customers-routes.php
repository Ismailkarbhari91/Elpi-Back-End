...
use Webkul\Admin\Http\Controllers\Customer\BillingsController;
use Webkul\Admin\Http\Controllers\Customer\ShippingsController;
...
Route::group(['middleware' => ['web', 'admin'], 'prefix' => config('app.admin_url')], function () {
    ...
    //billing
    Route::get('customers/{id}/billingaddress', [BillingsController::class, 'show'])
        ->defaults('_config', ['view' => 'admin::customers.addresses.billing'])
        ->name('admin.customer.billing');

    Route::post('customers/billingaddressupadte', [BillingsController::class, 'store'])
        ->defaults('_config', ['redirect' => 'admin.customer.index'])
        ->name('admin.customer.billingedit');
    //

    // shipping
    Route::get('customers/{id}/shippingaddress', [ShippingsController::class, 'show'])
    ->defaults('_config', ['view' => 'admin::customers.addresses.shipping'])
    ->name('admin.customer.shipping');

    Route::post('customers/shippingaddressupadte', [ShippingsController::class, 'store'])
    ->defaults('_config', ['redirect' => 'admin.customer.index'])
    ->name('admin.customer.shippinggedit');
